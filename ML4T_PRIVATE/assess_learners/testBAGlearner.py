...
if __name__=="__main__":
    ...
    leaf_sizes = np.arange(1, 400, 5)
    train_RMSE = []
    test_RMSE = []
    for leaf_size in leaf_sizes:
        learner = bg.BagLearner(dt.DTLearner, kwargs = {"leaf_size":leaf_size}, bags=20, boost=False, verbose=False)
    ...
    plt.ylabel(("RMSE"))
    plt.title("Leaf Size for Bag Learner (20 bags, DTLearner) (Istanbul Data) vs. RMSE")
    plt.show()
